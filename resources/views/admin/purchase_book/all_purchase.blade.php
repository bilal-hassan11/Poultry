						...
						<tbody>
                            @foreach($purchases AS $purchase)
                                <tr style="border-color:black;">
                                    ...
                                    <td width="120">
                                        <a href="{{route('admin.purchases.edit_purchase', $purchase->hashid)}}" class="btn btn-primary btn-xs waves-effect waves-light">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" onclick="ajaxRequest(this)" data-url="{{ route('admin.sales.delete_sale', ['id'=>$purchase->hashid]) }}"  class="btn btn-danger btn-xs waves-effect waves-light">
