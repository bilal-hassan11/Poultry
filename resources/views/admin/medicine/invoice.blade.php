...
<!-- Mirrored from lion-admin-templates.multipurposethemes.com/bs5/template/horizontal/main/invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Dec 2022 16:28:02 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Lion Admin - Dashboard  Invoice </title>
...
<div class="wrapper">
  ...
  <nav class="main-nav" role="navigation">
	  ...
	  <ul id="main-menu" class="sm sm-blue">			
		...
		<li><a href="#"><i data-feather="file-plus"></i>Apps</a>					
		  	<ul>					
				...
				<li><a href="reports.html"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Reports</a></li>	
				<li><a href="projects.html"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Projects</a></li>	
				<li><a href="accounting.html"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Project Budget</a></li>	
				<li><a href="file_manager.html"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>File Manager</a></li>			
		  	</ul>
		</li>   
		<li><a href="#"><i data-feather="headphones"></i>Support</a>
			<ul>
		...
		<li><a href="#"><i data-feather="anchor"></i>Widgets</a>
		  <ul>
		...
		<li><a href="#"><i data-feather="lock"></i>Login &amp; Error</a>
		  <ul>
			<li><a href="#"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Authentication</a>
			  <ul>
				<li>
					<a href="auth_login.html" class="d-light" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Login</a>
					<a href="auth_login_dark.html" class="d-dark" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Login</a>
				</li>
				<li>
					<a href="auth_register.html" class="d-light" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Register</a>
					<a href="auth_register_dark.html" class="d-dark" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Register</a>
				</li>
				<li>
					<a href="auth_lockscreen.html" class="d-light" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Lockscreen</a>
					<a href="auth_lockscreen_dark.html" class="d-dark" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Lockscreen</a>
				</li>
				<li>
					<a href="auth_user_pass.html" class="d-light" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Recover password</a>
					<a href="auth_user_pass_dark.html" class="d-dark" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Recover password</a>
				</li>	
			  </ul>			  
			</li>
			<li><a href="#"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Miscellaneous</a>
			  <ul>
				<li>
					<a href="error_404.html" class="d-light" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Error 404</a>
					<a href="error_404_dark.html" class="d-dark" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Error 404</a>
				</li>
				<li>
					<a href="error_500.html" class="d-light" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Error 500</a>
					<a href="error_500_dark.html" class="d-dark" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Error 500</a>
				</li>
				<li>
					<a href="error_maintenance.html" class="d-light" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Maintenance</a>
					<a href="error_maintenance_dark.html" class="d-dark" target="_blank"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Maintenance</a>
				</li>
			  </ul>			  
			</li>
		  </ul>		  
		</li>
		<li><a href="#"><i data-feather="box"></i>UI</a>			
		  <ul>
		...
		<li><a href="#"><i data-feather="trello"></i>Forms & Table</a>
		  <ul>
		...
		<li><a href="#"><i data-feather="file-text"></i>Pages</a>
		  <ul>
			...
			<div class="row mt-4">
				...
				<div class="col-sm-4">
					<div class="text-sm-end">
						<img src="{{ asset('new_assets') }}/images/qrcode.png" alt="barcode-image" class="w-150 img-fluid me-2" />
					</div>
				</div> <!-- end col-->
			</div>    
			<!-- end row -->        
...
<!-- ./wrapper -->
    ...
    <script src="{{ asset('new_assets') }}/assets/icons/feather-icons/feather.min.js"></script>	<script src="{{ asset('new_assets') }}/assets/vendor_plugins/JqueryPrintArea/demo/jquery.PrintArea.js"></script>
	...
	<script src="{{ asset('new_assets') }}/js/pages/invoice.js"></script>

</body>

<!-- Mirrored from lion-admin-templates.multipurposethemes.com/bs5/template/horizontal/main/invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Dec 2022 16:28:05 GMT -->
</html>
