                ...
                <form action="{{ route('admin.formulations.store') }}" class="ajaxForm" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label for="">Sale Items</label>
                            <select class="form-control" name="sale_item_id" id="sale_item_id" required>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control" name="sale_weight" id="sale_weight" required>
                    ...
                    @if(!isset($is_update))
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control purchase_item_id" name="purchase_item_id[]" id="purchase_item_id" required>
                                    <option value="">Select sale item</option>
...
<script>
    $(document).on('click', '.add_row', function(e){
        ...
        var html = '<div class="row">'+
                        '<div class="col-md-6 form-group">'+
                            '<label>g Item</label>'+
                            '<select class="form-control purchase_item_id" name="purchase_item_id[]" id="" required>'+
