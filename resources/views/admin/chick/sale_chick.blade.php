                ...
                @csrf
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="item_id" id="item_id">
                          ...
                          @foreach($category->items AS $item)
                            <option value="{{ $item->hashid }}" data-price="{{ $item->price }}" @if(@$edit_sale->item_id == $item->id) selected @endif>{{ $item->name }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Rate</label>
                        <input class="form-control" name="rate" id="rate" readonly value="{{ @$edit_sale->rate }}" required>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                    ...
                    <tbody>
                        @foreach($sale_chicks AS $sale) 
                          <tr>
                            ...
                            <td>
                              <a href="{{ route('admin.chicks.sale_edit',['id'=>$sale->hashid]) }}" class="btn btn-primary btn-xs waves-effect waves-light"  >
                                  <i class="fas fa-edit"></i>
                              </a>
                              <button type="button" onclick="ajaxRequest(this)" data-url="{{ route('admin.chicks.sale_delete', ['id'=>$sale->hashid]) }}"  class="btn btn-danger btn-xs waves-effect waves-light">
